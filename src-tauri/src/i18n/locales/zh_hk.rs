...
pub static CHINESE_TRADITIONAL_HK_TRANSLATIONS: LazyLock<LocaleTranslations> = LazyLock::new(
    || {
        ...
        translations.insert(LABEL_SOURCE_CODE, TranslationValue::Text("源代碼"));
