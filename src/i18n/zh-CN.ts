...
export const dict: RawDictionary = {
  ...
  settings: {
    ...
    label: {
      ...
      customizedThemesDirectory: "自定义主题目录",
      version: "版本",
      language: "语言",
    ...
    help: {
      ...
      customizedThemesDirectory:
        "自定义主题并非一项简单的技能。如果你熟悉天文算法，可以根据内置的主题结构手动制作；否则，请使用此应用程序制作主题：",
    },
    ...
    tooltip: {
      ...
      openCustomizedThemesDirectory: "点击打开自定义主题目录。",
